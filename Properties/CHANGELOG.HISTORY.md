...
- updated [GUIDE.md](https://github.com/mettliebe/CS2_TranslateCS2/GUIDE.md)
    - Section 1.3
...
- DistributedBinaries
    - is a new directory and can be found over there
        - https://github.com/mettliebe/CS2_TranslateCS2/DistributedBinaries
    - from now on, for the current ModVersion, this directory contains a
        - a general [README.md](https://github.com/mettliebe/CS2_TranslateCS2/DistributedBinaries/README.md)
...
- Hashes
    - TranslateCS2.hashes
        ...
        - can be found over there: https://github.com/mettliebe/CS2_TranslateCS2/TranslateCS2.hashes
    - checkIntegrity.ps1
        ...
        - can be found over there: https://github.com/mettliebe/CS2_TranslateCS2/checkIntegrity.ps1
# Version 2.0.9.3
...
- ability to sideload translations that are provided via others mods
    ...
    - if errors occur while loading the translationfiles
        - dedicated error-messages are shown
            - for this mod, TranslateCS2, the message starts with
...
%AppData%\..\LocalLow\Colossal Order\Cities Skylines II\ModsSettings\TranslateCS2\
