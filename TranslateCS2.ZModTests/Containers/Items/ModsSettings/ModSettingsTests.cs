...
namespace TranslateCS2.ZModTests.Containers.Items.ModsSettings;
public class ModSettingsTests : AProvidesTestDataOk {
    ...
    public void SectionNamesTest() {
        Assert.Equal("TabSettings", ModSettings.TabSettings);
        Assert.Equal("TabDevelopers", ModSettings.TabDevelopers);
    }
