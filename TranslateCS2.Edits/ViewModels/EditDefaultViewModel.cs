...
internal class EditDefaultViewModel : AEditViewModel<EditDefaultViewModel> {
    ...
    public List<ILocalizationKeyFilter> FiltersCustom { get; } = [];
    public List<ILocalizationKeyFilter> FiltersAutogenerated { get; } = [];
    public EditDefaultViewModel(IContainerProvider containerProvider,
        ...
        this.FiltersCustom.AddRange(this.filtersService.GetFiltersCustom());
        this.FiltersAutogenerated.AddRange(this.filtersService.GetFiltersAutogenerated());
